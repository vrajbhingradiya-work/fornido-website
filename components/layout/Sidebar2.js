...
export default function Sidebar2({ isBurgerMenu, handleBurgerMenu }) {
  return (
    <>
      <div
        className={`side-menu-wrapper tgCanvas-menu ${
          isBurgerMenu ? "side-menu-show" : ""
        }`}
      >
      ...
      <div
        className="sidebar-menu-backdrop tgCanvas-backdrop"
      ...
      <div className="sidebar-menu-two">
        ...
        <div className="sidebar-logo">
          <Link href="/">
            <img src="/assets/img/logo/logo02-dark.png" alt="" />
          </Link>
        </div>
      </div>
    </>
